...
* **No Console AWS:** Atua como o "guarda de trânsito" da rede. No painel, ele direciona ativamente os pacotes que saem da sub-rede pública em direção à internet através do IGW, exigindo que seja as abas de "Rotas" e "Associações de Sub-rede".
